...
geno_compet_simulate_snp <- function(madII, G.cor, E.cor, dirh2, compG.var, fra.CompE, plotSize, repl){
...
for(s in c(1:20)){
#create data1
  Comp.list <- simulateComp_snp(madII, G.cor, E.cor, dirh2, compG.var, fra.CompE, plotSize)
...
#output the files simulation for one phi
 write.csv(entry.cor.melt, paste0("Competition","-G.cor", G.cor,"-E.cor",E.cor,"-dirh2", dirh2, "-compGvar", compG.var, "-fraE",fra.CompE,"-rep_",repl,"_entry_Effect_cor_melt.csv"))
 write.csv(entry.mse.melt, paste0("Competition","-G.cor", G.cor,"-E.cor",E.cor,"-dirh2", dirh2, "-compGvar", compG.var, "-fraE",fra.CompE,"-rep_",repl,"_entry_Effect_rmse_melt.csv"))
 write.csv(error.cor.melt, paste0("Competition","-G.cor", G.cor,"-E.cor",E.cor,"-dirh2", dirh2, "-compGvar", compG.var, "-fraE",fra.CompE,"-rep_",repl,"_error_Effect_cor_melt.csv"))
 write.csv(error.mse.melt, paste0("Competition","-G.cor", G.cor,"-E.cor",E.cor,"-dirh2", dirh2, "-compGvar", compG.var, "-fraE",fra.CompE,"-rep_",repl,"_error_Effect_rmse_melt.csv"))
 write.csv(herit.melt, paste0("Competition","-G.cor", G.cor,"-E.cor",E.cor,"-dirh2", dirh2, "-compGvar", compG.var, "-fraE",fra.CompE,"-rep_",repl,"_herit_melt.csv"))
 write.csv(fraEr.melt, paste0("Competition","-G.cor", G.cor,"-E.cor",E.cor,"-dirh2", dirh2, "-compGvar", compG.var, "-fraE",fra.CompE,"-rep_",repl,"_fraSp_melt.csv"))
 write.csv(varGs.melt, paste0("Competition","-G.cor", G.cor,"-E.cor",E.cor,"-dirh2", dirh2, "-compGvar", compG.var, "-fraE",fra.CompE,"-rep_",repl,"_varGs_melt.csv"))
 ...
 write.csv(entry.cor.2, paste0("Competition","-G.cor", G.cor,"-E.cor",E.cor,"-dirh2", dirh2, "-compGvar", compG.var, "-fraE",fra.CompE,"-rep_",repl,"_entry_Effect_cor_final.csv"))
 write.csv(entry.mse.2, paste0("Competition","-G.cor", G.cor,"-E.cor",E.cor,"-dirh2", dirh2, "-compGvar", compG.var, "-fraE",fra.CompE,"-rep_",repl,"_entry_Effect_mse_final.csv"))
 write.csv(error.cor.2, paste0("Competition","-G.cor", G.cor,"-E.cor",E.cor,"-dirh2", dirh2, "-compGvar", compG.var, "-fraE",fra.CompE,"-rep_",repl,"_error_Effect_cor_final.csv"))
 write.csv(error.mse.2, paste0("Competition","-G.cor", G.cor,"-E.cor",E.cor,"-dirh2", dirh2, "-compGvar", compG.var, "-fraE",fra.CompE,"-rep_",repl,"_error_Effect_mse_final.csv"))
 write.csv(herit.2, paste0("Competition","-G.cor", G.cor,"-E.cor",E.cor,"-dirh2", dirh2, "-compGvar", compG.var, "-fraE",fra.CompE,"-rep_",repl,"_herit_final.csv"))
 write.csv(fra.Er.2, paste0("Competition","-G.cor", G.cor,"-E.cor",E.cor,"-dirh2", dirh2, "-compGvar", compG.var, "-fraE",fra.CompE,"-rep_",repl,"_fraCompE_final.csv"))
 write.csv(varGs.2, paste0("Competition","-G.cor", G.cor,"-E.cor",E.cor,"-dirh2", dirh2, "-compGvar", compG.var, "-fraE",fra.CompE,"-rep_",repl,"_varGs_final.csv"))
} #end of function
